...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-[#0b0f1a]">
      ...
      {/* ── Sidebar ── */}
      <aside className="fixed inset-y-0 left-0 w-60 bg-[#111827] border-r border-white/[0.07] flex flex-col z-50">

        {/* Logo */}
        <div className="flex items-center gap-3 px-5 py-6 border-b border-white/[0.07]">
          <div className="w-9 h-9 rounded-xl bg-accent flex items-center justify-center text-lg text-[#0b0f1a] flex-shrink-0">
            ✈
          </div>
          <div>
